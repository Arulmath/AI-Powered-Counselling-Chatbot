...
const videos = [
    {
        id: "j734gLbQFbU",                    // 10‑min gentle morning stretch
        title: "Gentle Morning Stretch ‑ 10 min",
        thumb: "https://img.youtube.com/vi/j734gLbQFbU/hqdefault.jpg",
      },
      {
        id: "2L2lnxIcNmo",                    // 5‑min wake‑up yoga flow
        title: "5‑Minute Wake‑Up Yoga Flow",
        thumb: "https://img.youtube.com/vi/2L2lnxIcNmo/hqdefault.jpg",
      },
      {
        id: "15Z1mtiJnyk",                    // quick box‑breathing guide
        title: "5 things to do every morning",
        thumb: "https://img.youtube.com/vi/15Z1mtiJnyk/hqdefault.jpg",
      },
      {
        id: "nux8f-QakBY",                    // power‑pose + affirmations
        title: "Listen To This Before You Start Your Day",
        thumb: "https://img.youtube.com/vi/nux8f-QakBY/hqdefault.jpg",
      },
  {
    id: "8TuRYV71Rgo",
    title: "Energising Yoga Flow",
    thumb: "https://img.youtube.com/vi/8TuRYV71Rgo/hqdefault.jpg",
  },
  {
    id: "cuFZ3NUwiPQ",
    title: "START FRESH EVERY DAY",
    thumb: "https://img.youtube.com/vi/cuFZ3NUwiPQ/hqdefault.jpg",
  },
  {
    id: "Jyy0ra2WcQQ",
    title: "Cold‑Splash Wake‑Up",
    thumb: "https://img.youtube.com/vi/Jyy0ra2WcQQ/hqdefault.jpg",
  },
  {
    id: "cZssjZnsN4Gg",
    title: "Power‑Pose Affirmations",
    thumb: "https://img.youtube.com/vi/ZssjZnsN4Gg/hqdefault.jpg",
  },
  {
    id: "nux8f-QakBY",                    // power‑pose + affirmations
    title: "Listen To This Before You Start Your Day",
...
/* ----------  COMPONENT  ---------- */
export default function FreshMornings() {
  ...
  return (
    <>
      ...
      <section className="pack">
        {/*<h1>For Fresh Mornings – Videos/Exercises</h1>*/}
